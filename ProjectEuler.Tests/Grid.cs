...
namespace ProjectEuler.Tests
{
    ...
    public class Grid
    {
        ...
        /// #11 math problem: "What is the greatest product of four 
        /// adjacent numbers in the same direction (up, down, left, 
        /// right, or diagonally) in the 20×20 grid?"
        /// </summary>
        /// <see cref="https://projecteuler.net/problem=11"/>
        [TestMethod]
        public void GetLargestProductInGrid()
        {
            int[][] grid = { 
            ...
            var question11 = ProjectEuler.Grid.GetLargestProductInGrid(grid);
